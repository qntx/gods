...
func benchmarkContains(b *testing.B, set *btreeset.Set[int], size int) {
	b.Helper()
...
func benchmarkAdd(b *testing.B, set *btreeset.Set[int], size int) {
	b.Helper()
...
func benchmarkRemove(b *testing.B, set *btreeset.Set[int], size int) {
	b.Helper()
